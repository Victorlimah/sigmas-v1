...
export function getDisciplines(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, service.getDisciplines()];
                case 1:
                    disciplines = _a.sent();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, service.getDiscipline(id)];
                case 1:
                    discipline = _a.sent();
                    res.send(discipline);
                    return [2 /*return*/];
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    discipline = req.body;
                    return [4 /*yield*/, service.createDiscipline(discipline)];
                case 1:
                    newDiscipline = _a.sent();
...
export function updateDiscipline(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var id, discipline, updatedDiscipline;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    id = Number(req.params.id);
                    discipline = req.body;
                    return [4 /*yield*/, service.updateDiscipline(id, discipline)];
                case 1:
                    updatedDiscipline = _a.sent();
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    id = Number(req.params.id);
                    return [4 /*yield*/, service.deleteDiscipline(id)];
                case 1:
                    _a.sent();
                    res.send();
                    return [2 /*return*/];
